...
@include('admin.layouts.inc.sidebar')
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <!-- Main Content -->
        <div id="content" style="background-color:#3C3F41">

            <!-- Topbar -->
        @include('admin.layouts.inc.header')
            <!-- End of Topbar -->
            <nav aria-label="breadcrumb" class="px-2 py-1 mb-4">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="#">Dashboard</a></li>
                    <li class="breadcrumb-item active text-light" aria-current="page">@yield('page_name')</li>
                </ol>
            </nav>
            <!-- Begin Page Content -->
            @yield('content')
